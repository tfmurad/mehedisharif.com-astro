...
const ContactForm: React.FC = () => {
	...
	const formHandler = (e: React.FormEvent<HTMLFormElement>) => {
		...
		fetch("https://formsubmit.co/ajax/murad.themefisher@gmail.com", {
			method: "POST",
	...
	return (
		<>
			<form className="text-base sm:text-h3" method="POST" onSubmit={formHandler}>
			...
			{submitted !== null && (
				<p className={`mt-6 text-base ${submitted ? "text-green-400" : "text-red-400"}`}>
					{submitted ? "Message Submitted Successfully!" : "Something went wrong! Please try again."}
				</p>
			)}
		</>
	);
